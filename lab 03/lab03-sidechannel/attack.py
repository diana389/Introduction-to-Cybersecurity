...
ITERATIONS = 1000
CHARACTERS = ascii_letters + digits + # TODO(1): fill in the missing characters
BRUTE_FORCE_LIMIT = 3 # chars to brute force at the end
CHECK_PASS_LEN_VULN = # TODO(2): fill in the correct function
CHECK_PASS_CHARS_VULN = # TODO(2): fill in the correct function
...
def find_length() -> int:
    ...
    times = [
        ...
        for length in range() # TODO(3): fill in an appropriate range
    ]
    ...
    while not q.empty():
        ...
        if len(p) != length - BRUTE_FORCE_LIMIT:
            ...
            for c in CHARACTERS:
                ...
                duration = # TODO(5): do a timed password check
                q.put((-duration, np))
        else:
